...
export  function LoginForm() {
  return (
   ...
   <Row>
    <h1 className='text-white text-3xl text-center font-poppins font-semibold' >please log in to your account </h1>
   </Row>
   ...
   <input type='password' required className={`${style.inputStyle} `}  placeholder='password' />
    ...
    <Row>
        <h1 className='text-white text-lg font-poppins  '>do you have an account <Link href={"/"} className='text-orange-500 text-lg'> create account</Link></h1>
    </Row>
   </Col>
  )
}
